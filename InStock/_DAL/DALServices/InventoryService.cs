...
namespace _DAL.DALServices
{
    ...
    public class InventoryService : IInventoryService
    {
        ...
        public IEnumerable<Inventory> GetInventoryItems()
        {
            ...
            var retItems = new List<Inventory>();
        ...
        public async Task PostInventoryItem(Inventory item)
        {
        ...
        public async Task PutInventoryItem(int id, Inventory item)
        {
            var efItem = _context.Inventories.Find(id);
